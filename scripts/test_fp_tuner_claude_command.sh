...
proposal = {
    "proposal": {
        ...
        "rule_line": "SecRule REQUEST_URI \"@beginsWith /search\" \"id:190888,phase:1,pass,nolog,ctl:ruleRemoveTargetById=100004;ARGS:q,msg:'mamotama fp_tuner scoped exclusion'\"",
    }
}
